...
import static com.epubra.epublib.validation.StructureSupport.isNavDocument;
import static com.epubra.epublib.validation.StructureSupport.nullSafe;
import static com.epubra.epublib.validation.StructureSupport.resolveTocResource;
...
final class OpfSpineRules {
    ...
    private static void checkOpfBasics(Book book, boolean containerMode, List<ValidationIssue> issues) {
        ...
        // B11
        if (book.version() != com.epubra.epublib.domain.EpubVersion.EPUB_3
                && book.version() != com.epubra.epublib.domain.EpubVersion.EPUB_2) {
