...
public final class ResourceOps {
    ...
    public static String buildInsertImageTag(String chapterHref, String imageHref, String alt) {
        String chapterDir = com.epubra.epublib.util.Hrefs.parentDirectory(chapterHref);
        String relative = com.epubra.epublib.util.Hrefs.relativize(chapterDir, imageHref);
